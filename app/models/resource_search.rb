...
class ResourceSearch
  ...
  SEARCH_ATTR = [:text, :topics, :redd_activities, :resource_types, :countries, :languages]
  RESULTS_PER_PAGE = 10

  attr_accessor *SEARCH_ATTR
  attr_reader :page, :results_per_page

  selectable_fields [:languages, :topics, :resource_types, :countries, :redd_activities, :technical_expertise]
